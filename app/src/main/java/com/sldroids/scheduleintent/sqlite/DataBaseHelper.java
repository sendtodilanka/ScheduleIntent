...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "order.db";// Database name
    ...
    public void createDataBase() throws IOException
    {
        ...
        // If the db doesn't exist
            ...
            try {
                ...
                Log.i(TAG, "db_version: " + mDataBase.getVersion());
                // If new db version is greater than exist db version
                if (DB_VERSION > mDataBase.getVersion()){
                    File dbFile = new File(DB_PATH + DB_NAME);
                    // delete the current db
                    dbFile.delete();
                    // check weather db is still exist
                    if(!checkDataBase())
                    {
                        // if db is deleted, then copy new db
                        this.getReadableDatabase();
                        this.close();
                        try
                        {
